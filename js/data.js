...
export const WORD_CARDS = [
    ...
    { id: 'tree', en: 'tree', zh: '樹', difficulty: 1, rarity: 'rare',
      type: 'defend', cost: 2, value: 8, emoji: '🌳',
      desc: '大樹守護，獲得 {v} 點護甲' },
    ...
    { id: 'rain', en: 'rain', zh: '雨', difficulty: 1, rarity: 'common',
      type: 'skill', cost: 1, value: 4, emoji: '🌧️',
    ...
    { id: 'milk', en: 'milk', zh: '牛奶', difficulty: 1, rarity: 'common',
      type: 'skill', cost: 1, value: 5, emoji: '🥛',
    ...
    { id: 'angry', en: 'angry', zh: '生氣的', difficulty: 2, rarity: 'rare',
      type: 'attack', cost: 1, value: 7, emoji: '😡',
      desc: '憤怒一擊，造成 {v} 點傷害', extra: { weak: 2 } },
...
export const ENEMIES = {
    ...
    dragon_lord: { name: '龍王', emoji: '🐉', hp: 90, isBoss: true, attacks: [
        { name: '龍息', damage: 12, emoji: '🔥', burn: 3 },

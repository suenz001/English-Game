...
export const WORD_CARDS = [
    ...
    { id: 'goodnight', en: 'goodnight', zh: '晚安', difficulty: 1, rarity: 'rare', type: 'defend', cost: 3, value: 10, emoji: '🌃', desc: '晚安曲，獲得 {v} 點護甲並抽 1 張牌', extra: { draw: 1 } },
    { id: 'town', en: 'town', zh: '城鎮', difficulty: 1, rarity: 'common', type: 'defend', cost: 2, value: 7, emoji: '🏘️', desc: '城鎮防禦牆，獲得 {v} 點護甲' },
    ...
    { id: 'apartment', en: 'apartment', zh: '公寓', difficulty: 1, rarity: 'common', type: 'defend', cost: 2, value: 7, emoji: '🏢', desc: '躲進公寓，獲得 {v} 點護甲' },
    ...
    { id: 'armchair', en: 'armchair', zh: '扶手椅', difficulty: 1, rarity: 'common', type: 'defend', cost: 2, value: 7, emoji: '🛋️', desc: '舒服地坐著，獲得 {v} 點護甲' },
    { id: 'lamp', en: 'lamp', zh: '檯燈', difficulty: 1, rarity: 'common', type: 'skill', cost: 0, value: 1, emoji: '🪔', desc: '點亮檯燈，獲得 {v} 點能量', extra: { energy: true } },
    { id: 'couch', en: 'couch', zh: '沙發', difficulty: 1, rarity: 'common', type: 'defend', cost: 2, value: 7, emoji: '🪑', desc: '躺在沙發上，獲得 {v} 點護甲' },
    { id: 'table', en: 'table', zh: '桌子', difficulty: 1, rarity: 'common', type: 'defend', cost: 1, value: 5, emoji: '🪚', desc: '躲進桌下，獲得 {v} 點護甲' },
    { id: 'cupboard', en: 'cupboard', zh: '櫥櫃', difficulty: 1, rarity: 'common', type: 'defend', cost: 2, value: 7, emoji: '🗄️', desc: '躲進櫃子，獲得 {v} 點護甲' },
    ...
    { id: 'star', en: 'star', zh: '星星', difficulty: 1, rarity: 'rare',
      ...
      desc: '星光充能，獲得 {v} 點能量並抽 1 張牌', extra: { energy: true, bonusDraw: 1 } },
    ...
    { id: 'cake', en: 'cake', zh: '蛋糕', difficulty: 1, rarity: 'rare',
      ...
      desc: '美味甜點，獲得 {v} 點能量並抽 1 張牌', extra: { energy: true, bonusDraw: 1 } },
    ...
    { id: 'flame', en: 'flame', zh: '火焰', difficulty: 2, rarity: 'epic',
      ...
      desc: '烈焰攻擊，造成 {v} 點傷害，並給予 2 層毒', extra: { poison: 2 } },
    ...
    { id: 'apple', en: 'apple', zh: '蘋果', difficulty: 2, rarity: 'rare',
      type: 'skill', cost: 1, value: 2, emoji: '🍎',
      desc: '健康蘋果，獲得 {v} 點能量並抽 1 張牌', extra: { energy: true, bonusDraw: 1 } },
    ...
    { id: 'dream', en: 'dream', zh: '夢', difficulty: 2, rarity: 'rare',
      type: 'skill', cost: 0, value: 1, emoji: '💭',
      desc: '美夢能量，獲得 {v} 點能量並抽 1 張牌', extra: { energy: true, bonusDraw: 1 } },
    ...
    { id: 'warrior', en: 'warrior', zh: '戰士', difficulty: 3, rarity: 'legendary',
      type: 'attack', cost: 2, value: 9, emoji: '⚔️',
    ...
    { id: 'battle', en: 'battle', zh: '戰鬥', difficulty: 3, rarity: 'epic',
      type: 'attack', cost: 1, value: 8, emoji: '💥',
      desc: '全力戰鬥，造成 {v} 點傷害，並給予 1 回合易傷', extra: { vulnerable: 1 } },
    { id: 'pirate', en: 'pirate', zh: '海盜', difficulty: 3, rarity: 'epic',
      type: 'attack', cost: 1, value: 7, emoji: '🏴‍☠️',
      desc: '海盜突襲，造成 {v} 點傷害，並給予 2 回合虛弱', extra: { weak: 2 } },
    ...
    { id: 'island', en: 'island', zh: '島嶼', difficulty: 3, rarity: 'epic',
      type: 'defend', cost: 2, value: 13, emoji: '🏝️',
      desc: '島嶼結界，獲得 {v} 點護甲' },
    ...
    { id: 'bridge', en: 'bridge', zh: '橋', difficulty: 3, rarity: 'epic',
      ...
      desc: '橋樑防禦，獲得 {v} 點護甲並抽 1 張牌', extra: { draw: 1 } },
    ...
    { id: 'rainbow', en: 'rainbow', zh: '彩虹', difficulty: 3, rarity: 'epic',
      type: 'skill', cost: 1, value: 2, emoji: '🌈',
      desc: '彩虹光芒，獲得 {v} 點能量並抽 2 張牌', extra: { energy: true, bonusDraw: 2 } },
    ...
    { id: 'crystal', en: 'crystal', zh: '水晶', difficulty: 3, rarity: 'epic',
      type: 'skill', cost: 0, value: 2, emoji: '🔮',
      desc: '水晶能量，獲得 {v} 點能量並抽 1 張牌', extra: { energy: true, bonusDraw: 1 } },

    { id: 'potion', en: 'potion', zh: '藥水', difficulty: 3, rarity: 'legendary',
      type: 'skill', cost: 0, value: 3, emoji: '🧪',
      desc: '神奇藥水，獲得 {v} 點能量並抽 1 張牌', extra: { energy: true, bonusDraw: 1 } },
...
export function getQuizMode() {
    try { return JSON.parse(localStorage.getItem('vocabSpire_quizMode')) || 'card'; }
    catch { return localStorage.getItem('vocabSpire_quizMode') || 'card'; }
}

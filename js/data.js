...
export const WORD_CARDS = [
    ...
    { id: 'bee', en: 'bee', zh: '蜜蜂', difficulty: 1, rarity: 'rare',
      ...
      desc: '蜜蜂螫刺，造成 {v} 點傷害', extra: { poison: 2 } },
    ...
    { id: 'bed', en: 'bed', zh: '床', difficulty: 1, rarity: 'common',
      ...
      desc: '棉被防禦，獲得 {v} 點護甲' },
    { id: 'bag', en: 'bag', zh: '書包', difficulty: 1, rarity: 'common',
      type: 'defend', cost: 1, value: 6, emoji: '🎒',
      desc: '書包擋住，獲得 {v} 點護甲' },
    ...
    { id: 'ice', en: 'ice', zh: '冰', difficulty: 1, rarity: 'rare',
      type: 'defend', cost: 1, value: 5, emoji: '🧊',
      desc: '冰牆防禦，獲得 {v} 點護甲', extra: { weak: 1 } },
    ...
    { id: 'sun', en: 'sun', zh: '太陽', difficulty: 1, rarity: 'common',
      type: 'skill', cost: 1, value: 6, emoji: '☀️',
      desc: '太陽治癒，回復 {v} 點HP', extra: { heal: true } },
    ...
    { id: 'rain', en: 'rain', zh: '雨', difficulty: 1, rarity: 'common',
      type: 'skill', cost: 1, value: 5, emoji: '🌧️',
      desc: '雨水洗禮，回復 {v} 點HP', extra: { heal: true } },
    ...
    { id: 'cake', en: 'cake', zh: '蛋糕', difficulty: 1, rarity: 'rare',
      type: 'skill', cost: 1, value: 8, emoji: '🎂',
      desc: '美味蛋糕，回復 {v} 點HP', extra: { heal: true } },
    { id: 'milk', en: 'milk', zh: '牛奶', difficulty: 1, rarity: 'common',
      type: 'skill', cost: 1, value: 6, emoji: '🥛',
      desc: '牛奶補充，回復 {v} 點HP', extra: { heal: true } },
    ...
    { id: 'sword', en: 'sword', zh: '劍', difficulty: 2, rarity: 'rare',
      type: 'attack', cost: 1, value: 8, emoji: '⚔️',
      desc: '揮劍斬擊，造成 {v} 點傷害' },
    ...
    { id: 'snake', en: 'snake', zh: '蛇', difficulty: 2, rarity: 'epic',
      type: 'attack', cost: 1, value: 4, emoji: '🐍',
      desc: '毒蛇咬擊，造成 {v} 點傷害', extra: { poison: 3 } },
    ...
    { id: 'shark', en: 'shark', zh: '鯊魚', difficulty: 2, rarity: 'epic',
      type: 'attack', cost: 2, value: 13, emoji: '🦈',
      desc: '鯊魚衝撞，造成 {v} 點傷害' },
    ...
    { id: 'shield', en: 'shield', zh: '盾牌', difficulty: 2, rarity: 'rare',
      type: 'defend', cost: 1, value: 8, emoji: '🛡️',
      desc: '舉起盾牌，獲得 {v} 點護甲' },
    { id: 'armor', en: 'armor', zh: '盔甲', difficulty: 2, rarity: 'epic',
      type: 'defend', cost: 2, value: 14, emoji: '🦺',
      desc: '穿上盔甲，獲得 {v} 點護甲' },
    ...
    { id: 'cloud', en: 'cloud', zh: '雲', difficulty: 2, rarity: 'epic',
      type: 'defend', cost: 1, value: 5, emoji: '☁️',
      desc: '雲霧隱身，獲得 {v} 點護甲並抽1牌', extra: { draw: 1 } },
    { id: 'house', en: 'house', zh: '房子', difficulty: 2, rarity: 'epic',
      type: 'defend', cost: 2, value: 13, emoji: '🏠',
      desc: '躲進房子，獲得 {v} 點護甲' },
    { id: 'pond', en: 'pond', zh: '池塘', difficulty: 2, rarity: 'rare',
      type: 'defend', cost: 1, value: 6, emoji: '🌊',
      desc: '池塘水盾，獲得 {v} 點護甲', extra: { weak: 1 } },
    ...
    { id: 'wall', en: 'wall', zh: '牆壁', difficulty: 2, rarity: 'epic',
      type: 'defend', cost: 2, value: 15, emoji: '🧱',
      desc: '高牆防禦，獲得 {v} 點護甲' },

    // --- 技能牌 ---
    { id: 'apple', en: 'apple', zh: '蘋果', difficulty: 2, rarity: 'rare',
      type: 'skill', cost: 1, value: 8, emoji: '🍎',
      desc: '蘋果回血，回復 {v} 點HP', extra: { heal: true } },
    { id: 'water', en: 'water', zh: '水', difficulty: 2, rarity: 'epic',
      type: 'skill', cost: 1, value: 10, emoji: '💧',
      desc: '泉水治療，回復 {v} 點HP', extra: { heal: true } },
    ...
    { id: 'happy', en: 'happy', zh: '快樂的', difficulty: 2, rarity: 'rare',
      type: 'skill', cost: 1, value: 8, emoji: '😊',
      desc: '快樂能量，回復 {v} 點HP', extra: { heal: true } },
    ...
    { id: 'candy', en: 'candy', zh: '糖果', difficulty: 2, rarity: 'rare',
      type: 'skill', cost: 1, value: 7, emoji: '🍬',
      desc: '糖果補血，回復 {v} 點HP', extra: { heal: true } },
    ...
    { id: 'flower', en: 'flower', zh: '花', difficulty: 3, rarity: 'epic',
      type: 'skill', cost: 1, value: 10, emoji: '🌸',
      desc: '花之治癒，回復 {v} 點HP', extra: { heal: true } },
    { id: 'potion', en: 'potion', zh: '藥水', difficulty: 3, rarity: 'legendary',
      type: 'skill', cost: 1, value: 18, emoji: '🧪',
      desc: '大補藥水，回復 {v} 點HP', extra: { heal: true } },
    ...
    { id: 'candle', en: 'candle', zh: '蠟燭', difficulty: 3, rarity: 'epic',
      ...
      desc: '燭光指引，獲得 {v} 能量並抽1牌', extra: { energy: true, bonusDraw: 1 } },
    { id: 'angel', en: 'angel', zh: '天使', difficulty: 3, rarity: 'legendary',
      type: 'skill', cost: 2, value: 25, emoji: '👼',
      desc: '天使祝福，回復 {v} 點HP', extra: { heal: true } },
    ...
    { id: 'phoenix', en: 'phoenix', zh: '鳳凰', difficulty: 3, rarity: 'legendary',
      ...
      desc: '鳳凰再生，每回合回復 {v} HP', extra: { regen: true } },
    { id: 'champion', en: 'champion', zh: '冠軍', difficulty: 3, rarity: 'legendary',
      type: 'power', cost: 3, value: 0, emoji: '🏆',
      desc: '冠軍氣場，本場攻擊傷害翻倍', extra: { doubleAtk: true } },
    { id: 'guardian', en: 'guardian', zh: '守護者', difficulty: 3, rarity: 'epic',
      type: 'power', cost: 1, value: 4, emoji: '🛡️',
...
export const ENEMIES = {
    slime: { name: '史萊姆', emoji: '🟢', hp: 22, attacks: [
        { name: '撞擊', damage: 4, emoji: '💥' },
        { name: '黏液', damage: 2, emoji: '💧', applyWeak: 2 },
        { name: '分裂', damage: 0, emoji: '🟢', heal: 5 },
    ]},
    bat: { name: '蝙蝠', emoji: '🦇', hp: 16, attacks: [
        { name: '啃咬', damage: 5, emoji: '🦷' },
        { name: '超音波', damage: 3, emoji: '🔊', applyVuln: 2 },
    ]},
    goblin: { name: '哥布林', emoji: '👺', hp: 26, attacks: [
        { name: '棍棒', damage: 6, emoji: '🏏' },
        { name: '偷竊', damage: 3, emoji: '💰' },
        { name: '嘲諷', damage: 0, emoji: '😜', applyWeak: 2 },
    ]},
    mushroom: { name: '毒蘑菇', emoji: '🍄', hp: 18, attacks: [
        { name: '毒孢子', damage: 2, emoji: '☁️', poison: 2 },
        { name: '頭槌', damage: 5, emoji: '💥' },
        { name: '迷幻粉', damage: 0, emoji: '🌀', applyVuln: 2, applyWeak: 1 },
    ]},
    skeleton: { name: '骷髏兵', emoji: '💀', hp: 38, attacks: [
    ...
    dark_wolf: { name: '暗影狼', emoji: '🐺', hp: 32, attacks: [
        { name: '撕咬', damage: 9, emoji: '🦷' },
        { name: '嚎叫', damage: 0, emoji: '🌙', buffSelf: 2 },
        { name: '恐嚇', damage: 3, emoji: '😨', applyWeak: 2 },
    ]},
    orc: { name: '獸人', emoji: '👹', hp: 48, attacks: [
        { name: '巨斧', damage: 12, emoji: '🪓' },
        { name: '踐踏', damage: 7, emoji: '🦶', applyVuln: 1 },
        { name: '戰吼', damage: 0, emoji: '📢', buffSelf: 3, block: 5 },
    ]},
    dark_knight: { name: '黑騎士', emoji: '🖤', hp: 58, attacks: [
        { name: '暗黑斬', damage: 14, emoji: '⚔️' },
        { name: '黑盾', damage: 0, emoji: '🛡️', block: 10 },
        { name: '恐懼', damage: 5, emoji: '😱', applyWeak: 3 },
        { name: '破甲', damage: 6, emoji: '💔', applyVuln: 2 },
    ]},
    necromancer: { name: '死靈法師', emoji: '🧙', hp: 44, attacks: [
        { name: '暗影彈', damage: 10, emoji: '🔮' },
        { name: '吸血', damage: 8, emoji: '🩸', heal: 8 },
        { name: '虛弱詛咒', damage: 0, emoji: '☠️', applyWeak: 3, applyVuln: 2 },
    ]},
    dragon_lord: { name: '龍王', emoji: '🐉', hp: 110, isBoss: true, attacks: [
        { name: '龍息', damage: 15, emoji: '🔥', burn: 3 },
        { name: '尾擊', damage: 10, emoji: '💥', applyVuln: 2 },
        { name: '龍鱗', damage: 0, emoji: '🛡️', block: 15 },
        { name: '毀滅吐息', damage: 25, emoji: '☄️' },
